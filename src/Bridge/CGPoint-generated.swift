...
extension CGPoint : VecType2, FloatVecType, CustomStringConvertible, JsonArrayInitable {
  ...
  func dot(_ b: CGPoint) -> Scalar { return (x * b.x) + (y * b.y) }
  func angle(_ b: CGPoint) -> Scalar { return acos(self.dot(b) / (self.len * b.len)) }
  func lerp(_ b: CGPoint, _ t: Scalar) -> CGPoint { return self * (1 - t) + b * t }
