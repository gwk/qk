...
struct V2F32: Printable, Equatable {
  var x, y: F32
...
func ==(a: V2F32, b: V2F32) -> Bool {
  return a.x == b.x && a.y == b.y
}


struct V2F64: Printable, Equatable {
  var x, y: F64
...
func ==(a: V2F64, b: V2F64) -> Bool {
  return a.x == b.x && a.y == b.y
}


struct V3F32: Printable, Equatable {
  var x, y, z: F32
...
func ==(a: V3F32, b: V3F32) -> Bool {
  return a.x == b.x && a.y == b.y && a.z == b.z
}


struct V3F64: Printable, Equatable {
  var x, y, z: F64
...
func ==(a: V3F64, b: V3F64) -> Bool {
  return a.x == b.x && a.y == b.y && a.z == b.z
}


struct V4F32: Printable, Equatable {
  var x, y, z, w: F32
...
func ==(a: V4F32, b: V4F32) -> Bool {
  return a.x == b.x && a.y == b.y && a.z == b.z && a.w == b.w
}


struct V4F64: Printable, Equatable {
  var x, y, z, w: F64
